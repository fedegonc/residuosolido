...
/**
 * Usa Messages inyectado — antes era una copia propia que usaba la
 * variante de getMessage() SIN fallback (tiraba NoSuchMessageException si
 * faltaba la clave, justo en la página de error). El redirect por rol
 * reusa Routes.resolveErrorNavigation — gana la guarda anti-loop que esa
 * función ya tiene (ver #144: el bug real de loop infinito era exactamente
...
public class GlobalErrorController implements ErrorController {
    ...
    public GlobalErrorController(Messages messages) {
