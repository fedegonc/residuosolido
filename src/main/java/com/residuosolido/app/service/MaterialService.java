...
public class MaterialService {
    ...
    public List<Material> search(String query) {
        ...
        return materialRepository.findByNameContainingIgnoreCaseOrDescriptionContainingIgnoreCaseOrCategoryContainingIgnoreCase(query.trim(), query.trim(), query.trim());
    }
